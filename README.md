...
If you run the app online, be sure to handle access control and HTTPS yourself. I personally use Nginx Proxy Manager’s Access Lists and certificats features (https://nginxproxymanager.com/) for that.
