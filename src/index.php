...
<body>   
    ...
    <div class="containbuttons">
        ...
        </script>        <div class="trashnotebutton" onclick="window.location = 'trash.php';"><span style="text-align:center;"><span title="Go to the trash" class="fas fa-trash-alt"></span></span></div>
