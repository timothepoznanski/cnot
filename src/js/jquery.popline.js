    ...
    prototype: {
      ...
      switchBar: function(button, hideFunc, showFunc) {
        if (typeof(hideFunc) === "function") {
          ...
          _this.bar.animate({ opacity: 0, marginTop: -_this.bar.height() + 'px' }, 5, function() { // Le 5 correspond au deuxi�me param�tre optionnel (si je ne le met pas �a fait un effet lent...) de la fonction animate qui est le temps d'animation en ms
            hideFunc.call(this);
